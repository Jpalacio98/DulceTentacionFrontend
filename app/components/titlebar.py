...
def titlebar(page: ft.Page):
    ...
    def on_max_click(e):
        if page.is_maximized:
            ...
            page.window.center()
            max_button.content = ft.Image(src="static/icons/maximize.png", width=20, height=20)
            max_button.tooltip = "Restaurar"
            page.window.maximized = False
            page.is_maximized = False
        else:
            # Maximizar la ventana
            max_button.content = ft.Image(src="static/icons/restore.png", width=20, height=20)
            max_button.tooltip = "Restaurar"
    ...
    max_button = ft.IconButton(
        content=ft.Image(src="static/icons/restore.png", width=20, height=20),
        tooltip="Maximizar",on_click=on_max_click
    )
    min_button = ft.IconButton(
        content=ft.Image(src="static/icons/minimize.png", width=20, height=20),
        tooltip="Minimizar",on_click=on_min_click
    )
    close_button = ft.IconButton(
        content=ft.Image(src="static/icons/close.png", width=20, height=20),
    ...
    return ft.Container(
        ...
        content=ft.Row(
            [
                ft.Image(src="static/icons/facebook.png", width=40, height=40),
                ft.WindowDragArea(
